    ...
    <>
      ...
      <div className="absolute top-0 backdrop-blur-2xl w-screen h-screen flex flex-col justify-between">
        ...
        <div className="flex justify-center items-center">
          <div className='rounded-md bg-transparent border-t-2 p-8 shadow-2xl flex flex-col justify-center'>
            <div>
            ...
            <div className="w-full flex flex-col mt-5">
              <Button className="bg-green-500" children={"Initiate Transfer"} onClick={async () => {
                toast.promise(axios.post("https://paymentapp-sqmb.onrender.com/api/v1/account/transfer", {
                  recipientId: id,
                  amount: amount
                },
                  {
